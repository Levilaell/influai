...
export function LoginForm() {
  // Preserva o destino original (ex.: link do e-mail /personas/<id>): o middleware
  // manda pra /login?callbackUrl=... e o login volta pra lá — antes caía em /brands.
  ...
  return (
      <Card className="w-full max-w-sm">
        ...
        <p className="mb-6 text-sm text-muted">Entre na sua fábrica de influenciadores.</p>
        ...
        <p className="mt-4 text-center text-sm">
          <Link href="/forgot" className="text-muted hover:text-accent">
            Esqueci minha senha
          </Link>
        </p>
